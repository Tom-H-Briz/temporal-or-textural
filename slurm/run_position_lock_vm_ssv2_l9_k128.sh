#!/bin/bash
#SBATCH --job-name=tot_pos_lock_vm_ssv2_l9_k128
#SBATCH --output=position_lock_vm_ssv2_l9_k128_%A_%a.out
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --time=04:00:00
#SBATCH --array=9

# k128/x16 L9 VM never got a post-30/07-fix position-lock run — only k64/x8
...
# k64 L9 job — dict-size doubling only adds SAE encode/decode cost, which is
