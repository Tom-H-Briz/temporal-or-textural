#!/bin/bash
#SBATCH --job-name=tot_pos_lock_vm_ssv2_l5_residual
#SBATCH --output=position_lock_vm_ssv2_l5_residual_%A_%a.out
#SBATCH --nodes=1
#SBATCH --gpus=1
...
# identity-splices layer L5's raw activation instead of a trained SAE (see
