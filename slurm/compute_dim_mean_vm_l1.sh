#!/bin/bash
#SBATCH --job-name=tot_dim_mean_vm_l1
#SBATCH --output=compute_dim_mean_vm_l1_%A_%a.out
#SBATCH --nodes=1
#SBATCH --gpus=1
...
export MODEL_NAME=videomae          # VM-only job — prereq for train_sae_vm_ssv2_l1.sh
