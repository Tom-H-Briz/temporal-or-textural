#!/bin/bash
#SBATCH --job-name=tot_train_sae_vm_ssv2_l1_7ep
#SBATCH --output=train_sae_vm_ssv2_l1_x8k64_7ep_%A_%a.out
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --time=02:30:00
#SBATCH --array=1

# L1 extension of train_sae_vm_ssv2_l5_l7_l9.sh — same job7ep/transformers==5.5.0
# setup, one more layer point on the VM-SSv2 side.
#
# Prereq: compute_dim_mean_vm_l1.sh completed — writes vmae_ssv2_layer1_dim_mean.pt.
