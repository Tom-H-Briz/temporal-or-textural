#!/bin/bash
#SBATCH --job-name=tot_pos_lock_vm_ssv2_l7_k128
#SBATCH --output=position_lock_vm_ssv2_l7_k128_%A_%a.out
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --time=04:00:00
#SBATCH --array=7

# k128/x16 L7 VM never got a post-30/07-fix position-lock run — only k64/x8
...
# k64 L7 job — dict-size doubling only adds SAE encode/decode cost, which is
