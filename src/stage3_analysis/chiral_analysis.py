...
CFG = {
    "extraction_path": str(ROOT / "outputs/analysis/chiral_extraction.parquet"),
    "activity_threshold": 17,
    "min_clips_surviving": 3,
    "min_dfa_percentile": 50,
    "top_n_features": 50,
    "output_dir": str(ROOT / "outputs/analysis/chiral/"),
    "class_ids": {93: "L2R", 94: "R2L"},
}
...
def save_csvs(
    ...
    l2r_only["direction"] = "L2R_only"

    r2l_only = r2l[r2l["feature_id"].isin(r2l_ids - l2r_ids)].copy()
    r2l_only["direction"] = "R2L_only"
...
def main() -> None:
    ...
    save_csvs(results["L2R"], results["R2L"], cfg)
